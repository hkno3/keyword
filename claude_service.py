...
아래 기사에서 일반인이 네이버에 직접 검색할 법한 키워드만 추출하세요. (최대 10개, 관련 있는 것만 — 억지로 채우지 말 것)

엄격한 조건:
- 기사의 핵심 소재(음식·성분·질병·장소·제품·증상·서비스 등)와 직접 관련된 단어만
- 절대 금지 — 업계 전문용어·직업명: "설계사", "계약자", "수급자", "피보험자", "가입자", "보험자", "중개인" 등
- 절대 금지 — 범용 비즈니스 단어: "효율", "안정성", "유통", "경쟁력", "산업", "기업", "정책", "시장", "전략", "현황", "동향"
- 절대 금지 — 추상적 단어: "혜택", "지원", "서비스", "제도", "방안", "강화", "개선"
- 반드시 한국어 (예: 유산균, 김치, 혈당, 오메가3, 치매, 실손보험, 태아보험)
- 일반인이 "이걸 알고 싶어서" 검색하는 단어 (정보 탐색 의도)

나쁜 예 (기사 주제가 보험이라면): 설계사, 보험계약자, 피보험자, 산업, 정책, 혜택
좋은 예 (기사 주제가 보험이라면): 실손보험, 태아보험, 암보험, 보험료, 갱신형보험
